...
> [EDA Анализ статистики каналов на YouTube. Классификация каналов по двум самым популярным категориям.](https://github.com/archimage-wiz/DS_PythonStat_Hw_Last/blob/main/Hw_YoutubeStatistics_Final.ipynb).<br>

> Верстка первого макета: [Демо На сервере](http://x-www.com/demo-maket1/).<br>
